        ...
        success {
            ...
            script {
                ...
                if (fileExists("${env.WORKSPACE}/extent-reports/test-report.html")) {
                    emailext(
                        subject: '[QA][Auto: Iphone 13"] Build Acceptance 6.7.4.1',
                        ...
                        to: 'aelango@bn.com,kvengattan@bn.com,ssidharthan@bn.com,mrajan@bn.com,pramachandran@bn.com,vpalanisamy@bn.com,skamuthu@bn.com,psaravanaguru@bn.com'
                    )
                } else {
